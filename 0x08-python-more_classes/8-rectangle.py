...
class Rectangle:
    ...
    Attributes:
        Class attributes:
            number_of_instances (int): class attribute that counts instance
            print_symbol (str): character to be used in __str__
        Instance attributes:
    ...
    def __del__(self):
        """
        Defines actions to take when deleting an instance of Rectangle
        """
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1
