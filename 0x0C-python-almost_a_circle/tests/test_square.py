...
class TestSquare(unittest.TestCase):
    ...
    def test_update(self):
        ...
        self.assertEqual(self.square_2.height, 15)
        self.assertEqual(self.square_2.size, 15)
        self.square_2.update(5, 20, 2)
        self.assertEqual(self.square_2.id, 5)
        self.assertEqual(self.square_2.size, 20)
        self.assertEqual(self.square_2.x, 2)
        self.assertEqual(self.square_2.y, 1)
        self.square_2.update(2, 15, 3, 3)
        self.assertEqual(self.square_2.id, 2)
        self.assertEqual(self.square_2.size, 15)
        self.assertEqual(self.square_2.x, 3)
        self.assertEqual(self.square_2.y, 3)
        self.square_2.update(4, y=2, size=5, x=3, id=89)
        self.assertEqual(self.square_2.id, 4)
        self.assertEqual(self.square_2.size, 15)
        self.assertEqual(self.square_2.width, 15)
        self.assertEqual(self.square_2.height, 15)
        self.assertEqual(self.square_2.x, 3)
        self.assertEqual(self.square_2.y, 3)
        self.square_2.update(y=1, size=10, x=1, id=2)
        self.assertEqual(self.square_2.id, 2)
        self.assertEqual(self.square_2.size, 10)
